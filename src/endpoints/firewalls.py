...
try:
    ...
    from src.utils.firewall_utils import update_firewall_fields, update_firewall_unique_field, update_new_firewall_policies
except ImportError:
    from models.firewall import db, Firewall
    from models.firewall_policy import FirewallPolicy
    from utils.firewall_utils import update_firewall_fields, update_firewall_unique_field, update_new_firewall_policies
...
def create_firewall():
    ...
    update_new_firewall_policies(new_firewall, data)
...
def update_firewall_policies(firewall_id: int):
    ...
    update_new_firewall_policies(firewall, data)
    db.session.commit()
